module.exports = {
  ...
  hello: function(req, res) {
    ...
    sails.sockets.join(req, 'userSockets');

    // Broadcast a notification to all the sockets who have joined
    // the "funSockets" room, excluding our newly added socket:
    sails.sockets.broadcast('userSockets', 'hello', { howdy: 'hi there!'}, req);

    var resp = "just got a socket request. user "+userEmail+" connected";
